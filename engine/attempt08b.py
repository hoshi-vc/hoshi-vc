...
# Based on attempt07_stage1, attempt08a
...
from engine.utils import (DATA_DIR, BaseLightningModule, LinearSchedule, log_attentions, log_audios2, log_spectrograms, log_spksim0, log_spksim1,
...
if __name__ == "__main__":
  ...
  model = VCModule(
      ...
      self_ratio=[(0, 1.0), (4000, 1.0), (6000, 0.0)],
      e2e_frames=64,
      grad_clip=1.0,
      hifi_gan=AttrDict({
          "resblock": "1",
