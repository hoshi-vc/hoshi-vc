...
class VCModel(nn.Module):
  ...
  def forward(self, batch: IntraDomainEntry4, src_ref_start: int, src_ref_len: int, n_rotated=0):
    ...
    batch_energy = discrete_energy(batch_energy)
    batch_pitch_i = discrete_pitch(batch_pitch_i)
    ...
    for i in range(n_rotated):
      ...
      src_pitch_i_rotated_converted = discrete_pitch(src_pitch_i_rotated_converted)
      src_pitch_rotated = self.forward_pitch(src_pitch_i_rotated_converted)
