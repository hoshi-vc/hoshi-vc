...
# Based on attempt07_stage1, attempt07a
...
if __name__ == "__main__":
  ...
  datamodule = DataModule08(
      P, frames=256, frames_ref=64, n_refs=32, ref_max_kth=8, batch_size=8, n_batches=2000, n_batches_val=200, same_density=True, num_workers=12)
